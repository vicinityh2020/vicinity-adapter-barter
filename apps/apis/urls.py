...
urlpatterns = [
    ...
    path('wallets/dash/events/jkhencRWTTTcvxelpQTppTrewvtxmmOOOnzrtbiologijafwvx', views.WalletEventsDash.as_view(), name='wallet_events_dash_view'),
    path('wallets/bitcoin/events/aeysafpomufreGIYTJKLgfwRFJHpmrfFpzoologijalisehfPMgs', views.WalletEventsBitcoin.as_view(), name='wallet_events_bitcoin_view'),
